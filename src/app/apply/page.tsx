        ...
        {uploadEnabled && (
          <Section title={settings!.evidence_label!}>
            ...
            <div className="flex flex-col gap-2">
              <DocumentDownload
                href="/downloads/[제출서류] 2026 AI 창업 경진대회 아이디어 제안서.hwpx"
                fileName="[제출서류] 2026 AI 창업 경진대회 아이디어 제안서.hwpx"
                label="아이디어 제안서 양식"
              />
              <DocumentDownload
                href="/downloads/[제출서류] 2026 AI 창업 경진대회 개인정보 수집 및 이용에 관한 동의서.hwpx"
                fileName="[제출서류] 2026 AI 창업 경진대회 개인정보 수집 및 이용에 관한 동의서.hwpx"
                label="개인정보 수집·이용 동의서"
              />
              <DocumentDownload
                href="/downloads/[제출서류] 2026 AI 창업 경진대회 참가서약서.hwpx"
                fileName="[제출서류] 2026 AI 창업 경진대회 참가서약서.hwpx"
                label="참가 서약서"
              />
            </div>
