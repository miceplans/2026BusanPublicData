...
const policySections = [
  {
    ...
    content: (
      <p>
        부산정보산업진흥원은 2026 AI 창업 경진대회 참가 신청의 접수, 신청자 본인
        확인, 참가 자격 확인, 신청 내용의 조회·수정, 심사 및 대회 운영, 신청
        완료 안내, 민원·문의 처리와 분쟁 대응을 위해 개인정보를 처리합니다.
    ...
    content: (
      <div className="overflow-x-auto">
          ...
          <tbody>
            <tr className="border-b border-black/10 align-top">
              ...
              <td className="px-4 py-4">
                팀명, 팀장 이름·소속·이메일·연락처·생년월일·성별·거주지, 참가
                유형, 참가 분야, 아이템명, 아이템 요약, 팀원(팀장 포함)
                이름·소속·역할·이메일·연락처·생년월일·성별·거주지, 지원대상 및
        ...
        <p className="mt-3 text-xs text-[#6b6b75]">
          팀장 연락처 뒤 4자리로 설정되는 신청 비밀번호는 복호화할 수 없는
          해시값으로 변환하여 저장하며 원문을 저장하지 않습니다.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <p>
        이 방침은 2026.8.26.부터 적용됩니다. 내용이 변경되는 경우 변경사항과
        시행일을 웹사이트를 통해 공개합니다.
      </p>
    ),
  },
